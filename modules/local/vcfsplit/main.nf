process VCFSPLIT {
    ...
    bcftools view -i 'FILTER=="NonSomatic" || FILTER=="Verdict_Germline"' $indel_vcf | bgzip -c > indels_filtered.vcf.gz
    bcftools view -i 'FILTER=="NonSomatic" || FILTER=="Verdict_Germline"' $snv_vcf | bgzip -c > snv_filtered.vcf.gz
